...
<div id="header">
	...
	<a href="${pageContext.request.contextPath}/resources">
        <div id="logo" alt="Spring Insight, Pivotal Technology" class="insight_logo"></div>
	</a>

	<ul>
        <li><a target="_blank" href="http://www.spring.io/">Home</a></li>
        <li><a target="_blank" href="http://www.spring.io/questions">Forum</a></li>
        <li><a target="_blank" href="http://www.spring.io/blog">Blog</a></li>
		<c:choose>
		  <c:when test="${devEdition}">
              <li><a target="_blank" href="http://tcserver.docs.pivotal.io/index.html">Help</a></li>
		  </c:when>
		  <c:otherwise>
              <li><a target="_blank" href="http://tcserver.docs.pivotal.io/index.html">Help</a></li>
		  </c:otherwise>
